...
Generate AI-powered featured images for your WordPress posts and pages using OpenAI's GPT-4 Vision (gpt-image-1).

== Description ==

AI Featured Image Generator is a WordPress plugin that adds a "Generate Featured Image" button to your post and page editors. When clicked, it uses AI image generation APIs to create a unique featured image based on your content title, selected style, and optional custom prompt.
...
= 1.0.2 =
* Enhanced meta box styling with modern design
* Added support for both posts and pages
* Updated WordPress compatibility requirements (6.0+ and PHP 8.0+)
...
= 1.0.2 =
Enhanced UI with modern styling and page support
